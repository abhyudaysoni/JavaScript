...
// // str1="i ekil tpircsavaj"
// let rev = str.split(" ");

// let rev2 = rev.map((element) => {
//   return element.split("").reverse().join("");
// });
// console.log(rev2.join(" ").slice(" ")); //try afterwards
...
//sort array based on Year
//try afterwards
const newData = data.sort((element) => {
